...
const SingleGridItem = ({ item }: { item: Product }) => {
  ...
  return (
    <div className="group" data-testid="product-item">
      <div className="relative overflow-hidden flex items-center justify-center rounded-lg bg-champagne-50 shadow-1 min-h-[270px] mb-4">
      ...
      <span className="flex items-center gap-2 font-medium text-lg" data-testid="product-price">
        <span className="text-onyx">{item.price} {item.currency}</span>
      </span>
    </div>
  );
};
